...
class MapModel(list):
	...
	def update(self, dt):
		...
		if not neighbors['bottom'] and not self.get_neighbors(*neighbors['bottom'].tpos)['right'] and self.player.states[YMovementState] is not Jumping:
